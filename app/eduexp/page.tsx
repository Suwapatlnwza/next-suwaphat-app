      ...
      <div className="flex w-[900px] rounded-2xl bg-gray-800 p-8 text-white shadow-lg">
        ...
        <div className="flex w-2/3 flex-col pl-8">
          ...
          <h1 className=" text-2xl font-bold">
           <span className="text-orange-400">2022-Present</span><br />
            UX/UI Designer
            <p className="text-sm text-gray-400">Freelance</p>
            <span className="text-orange-400"></span><br />
            Fullstack Web Developer
            <p className="mt-1 text-sm text-gray-400">Freelance</p>
            <p className="mt-1 text-sm text-gray-400">2022-2025</p>
            <p className="mt-1 text-sm font-bold text-white-400">Student in Technology Digital And Innovation</p>
            <p className="mt-1 text-sm text-gray-400">Southeast Asia University</p>
            <p className="mt-1 text-sm text-gray-400">2016-2021</p>
            <p className="mt-1 text-sm font-bold text-white-400">High School</p>
            <p className="mt-1 text-sm text-gray-400">Deebuk Phangnga Wittayayon School</p>
