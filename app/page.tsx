    ...
    <main className="flex min-h-screen items-center justify-center bg-gray-900">
      <div className="flex w-[900px] rounded-2xl bg-gray-800 p-8 text-white shadow-lg">
        ...
        <div className="flex w-2/3 flex-col pl-8">
          <p className="text-lg">
            Lets Work <span className="text-orange-400">Together !</span>
          </p>
          <h1 className="mt-2 text-2xl font-bold">
            Hi From <span className="text-orange-400">Suwaphat</span>,<br />
            Interactive Designer & Fullstack Web Developer
          </h1>
          <p className="mt-4 text-sm text-gray-400">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto
            maxime tempora at neque adipisci nulla voluptatem?
          </p>
